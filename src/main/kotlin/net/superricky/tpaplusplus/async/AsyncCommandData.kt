...
class AsyncCommandData(
    ...
    fun updateCurrentPos() {
        ...
        from ?: return
        pos = LevelBoundVec3(from.getDimension(), from.getX(), from.getY(), from.getZ())
    }
    ...
    fun checkWindupDistance(): Boolean {
        ...
        return pos.distance(LevelBoundVec3(checkTarget.getDimension(), checkTarget.getX(), checkTarget.getY(), checkTarget.getZ())) <= minDistance
    }
}
