...
object GlobalConst {
    ...
    const val DEFAULT_LANG_FILE_NAME = "zh_cn.toml"
    ...
    const val GITHUB_URL = "https://github.com/sweetljk/TpaPlusPlus-fabric-1.21.11"
    const val MODRINTH_URL = "https://modrinth.com/mod/tpa%2B%2B"
    const val CURSEFORGE_URL = "https://www.curseforge.com/minecraft/mc-mods/tpaplusplus"
